...
O webhook libera a compra no banco. O link magico e enviado somente quando o
comprador o solicita na pagina de login, evitando consumo duplicado do limite de
emails do Supabase. Para producao, configure SMTP proprio no Supabase Auth.
# K-Slim Members App
